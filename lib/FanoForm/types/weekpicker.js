(function (global, factory) {
  ...
  var WeekPicker = _datePicker2.default.WeekPicker;

  var FanoFormWeekPicker = function (_React$Component) {
    (0, _inherits3.default)(FanoFormWeekPicker, _React$Component);

    function FanoFormWeekPicker() {
      (0, _classCallCheck3.default)(this, FanoFormWeekPicker);
      return (0, _possibleConstructorReturn3.default)(this, (FanoFormWeekPicker.__proto__ || (0, _getPrototypeOf2.default)(FanoFormWeekPicker)).apply(this, arguments));
    }

    (0, _createClass3.default)(FanoFormWeekPicker, [{
      key: 'render',
      value: function render() {
        var props = (0, _form.getProps)(this.props, ['placeholder', 'disabled', 'allowClear', 'format', 'disabledDate']);
        return _react2.default.createElement(WeekPicker, props);
      }
    }]);
