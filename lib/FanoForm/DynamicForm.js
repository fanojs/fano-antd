  ...
  (0, _createClass2.default)(DynamicForm, [{
    ...
    value: function getFieldLabel(field, needMark) {
      var text = _react.default.createElement("span", {
        key: 'label',
        className: "fano-form-item-text fano-form-item-label-text"
      }, field.label);

      var mark = _react.default.createElement("span", {
        key: 'requiredMark',
        className: "fano-form-item-required-mark"
      }, "*");
      ...
      var colonGetter = function colonGetter() {
        ...
        return _react.default.createElement("span", {
          key: 'colon',
          className: "fano-form-item-colon fano-form-item-colon"
        }, mark);
      };
      ...
      for (var i = 0; i < fields.length; i++) {
        ...
        var formItemProps = {
          label: _react.default.createElement("span", {
            className: "fano-form-item-label fano-form-item-label fano-form-item-label-".concat(field.name)
          }, fieldLabel),
          colon: false
        };
        var formItemOptions = {
        ...
        cols.push(_react.default.createElement(_col.default, (0, _extends2.default)({
          ...
          className: "fano-form-item fano-form-item-".concat(field.name)
        }), _react.default.createElement("div", {
          className: "fano-form-item-ctrl fano-form-ctrl fano-form-ctrl-".concat(field.name),
          style: style
